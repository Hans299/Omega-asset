    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 left-collaboration">
                <img src="<?= base_url('public/assets/images/partner/logo-stargeneration.png') ?>" class="img-collaboration">
            ...
            <div class="col-md-4 right-collaboration">
                <div class="form-collaboration">
                    ...
                    <form action="<?= base_url('post-register-stargeneration') ?>" method="post">
                        <div class="form-row">
