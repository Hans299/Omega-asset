    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 left-collaboration">
                <img src="<?= base_url('public/assets/images/partner/logo-mgbkmlg.png') ?>" class="img-collaboration" style="width:200px;display:block">
            ...
            <div class="col-md-4 right-collaboration">
                <div class="form-collaboration">
                    ...
                    <form action="<?= base_url('post-register-mgbkmalang') ?>" method="post">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control" name="school">
                                    ...
                                    <option value="323">SMAK Kolese Santo Yusup Malang</option>
                                    <option value="324">SMA Kalam Kudus Malang</option>
                                    <option value="325">SMAK Santa Maria Malang</option>
                                    <option value="326">SMA Taman Harapan Malang</option>
                                    <option value="327">SMAN 4 Malang</option>
                                    <option value="328">SMAN 3 Malang</option>
                                    <option value="329">SMAN 10 Malang</option>
                                    <option value="330">SMAN 5 Malang</option>
                                    <option value="331">SMAN 1 Batu</option>
                                    <option value="332">SMAS Katolik Cor Jesu Malang</option>
                                </select>
                            </div>
                            <div class="form-group col-md-12">
