...
<header id="site-header" class="fixed-top">
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg stroke">
            <a href="#"><img src="<?= base_url('public/assets/images/partner/logo-lingotalk.png') ?>" class="logo-collaboration"></a>
...
<!-- consults -->
<section class="bg-lingotalk py-md-5 pt-md-0 py-1 pt-5" style="padding-top: 125px !important;">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-4 right-collaboration">
                <div class="form-collaboration">
                    ...
                    <form action="<?= base_url('post-register-lingotalk') ?>" method="post">
                        <div class="form-row">
