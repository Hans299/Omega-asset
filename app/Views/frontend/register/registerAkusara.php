...
<!-- consults -->
<section class="py-md-5 pt-md-0 py-1 pt-5 bg-palegreen" style="padding-top: 125px !important;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 left-collaboration">
                <img src="<?= base_url('public/assets/images/partner/logo-akusara.png') ?>" class="img-collaboration" style="width: 120px;display:block">
            ...
            <div class="col-md-4 right-collaboration">
                <div class="form-collaboration">
                    ...
                    <form action="<?= base_url('post-register-akusara') ?>" method="post">
                        <div class="form-row">
