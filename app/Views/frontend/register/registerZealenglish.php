    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 left-collaboration">
                <img src="<?= base_url('public/assets/images/partner/logo-zealenglish.png') ?>" class="img-collaboration" style="width: 200px;display:block">
            ...
            <div class="col-md-4 right-collaboration">
                <div class="form-collaboration">
                    ...
                    <form action="<?= base_url('post-register-zealenglish') ?>" method="post">
                        <div class="form-row">
