    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 left-collaboration">
                <img src="<?= base_url('public/assets/images/partner/logo-briton.png') ?>" class="img-collaboration">
                <img src="<?= base_url('public/assets/images/briton1.png') ?>" class="img-briton">
                <div class="c-briton">
                    <h6>Supported by:</h6>
                    <img src="<?= base_url('public/assets/images/logo-omega.png') ?>" class="c-img-briton">
                </div>
            </div>
            <div class="col-md-4 right-collaboration">
                <div class="form-collaboration">
                    <h3 class="h3-collaboration">Register Now</h3>
                    <form action="<?= base_url('post-register-briton-english') ?>" method="post">
                        <div class="form-row">
