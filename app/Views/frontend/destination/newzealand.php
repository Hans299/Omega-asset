...
<section class="section-row">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-7">
                <div class="lead">
                    New Zealand is famous for its natural scenery. In the quality of education, New Zealand excels 
                    in several fields, such as Science, Mathematic, Culinary, Hospitality, Tourism, and Engineering.
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-5 d-md-block d-none">
                <img src="<?= base_url('public/assets/images/destination/newzealand.png') ?>" class="img-destination">
            </div>
            <div class="col-md-7">
                <div class="destination-article">
                    <div class="destination-heading">
                        <h3>Why New Zealand?</h3>
                    </div>
                    <div class="destination-paragraph">
                        <p>
                            1. A country that has many very beautiful natural tourist attractions. <br>
                            2. High quality education and internationally recognized. <br>
                            3. Permit to work part time 20 hours per week during school and full time 40 hours during school holidays. <br>
                        </p>
                    </div>
                    <div class="destination-heading">
                        <h3>Living Cost in New Zealand</h3>
                    </div>
                    <div class="destination-paragraph">
                        <p>
                            The living cost in New Zealand varies greatly depending on your lifestyle and the city in which you live.
                            The average living cost required by a student in New Zealand generally ranges from NZD 1,500 to NZD 2,500 per month. 
                    ...
                    <div class="destination-paragraph">
                        <p>
                            To be able to enroll in an New Zealand university, you need to meet a number of conditions, such as: <br>
                            1. Student Visa <br>
