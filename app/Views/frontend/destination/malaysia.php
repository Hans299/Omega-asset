...
<section class="section-row">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-7">
                <div class="lead">
                    Many students choose to continue their studies in Malaysia because they are not difficult to 
                    adapt to life there considering the culture is almost similar to Indonesia. 
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-5 d-md-block d-none">
                <img src="<?= base_url('public/assets/images/destination/malaysia.png') ?>" class="img-destination">
            </div>
            <div class="col-md-7">
                <div class="destination-article">
                    ...
                    <div class="destination-paragraph">
                        <p>
                            1. Close to Indonesia. <br>
                            2. The cost is quite affordable. <br>
                            3. Permit to work part-time 20 hours per week during school holidays. <br>
                            4. Multicultural Country. <br>
                            5. Culinary and Tourism Variety. <br>
                        </p>
                    </div>
                    <div class="destination-heading">
                        <h3>Living Cost in Malaysia</h3>
                    </div>
                    <div class="destination-paragraph">
                        <p>
                            The living cost in Malaysia varies greatly depending on your lifestyle and the city in which you live. 
                            The average living cost required by a student in Malaysia generally ranges from RM 1,300 to RM 3,500 per month. 
                    ...
                    <div class="destination-paragraph">
                        <p>
                            To be able to enroll in an Malaysia university, you need to meet a number of conditions, such as: <br>
                            1. Student Visa <br>
