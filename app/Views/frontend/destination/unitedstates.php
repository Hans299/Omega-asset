...
<section class="section-row">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-7">
                <div class="lead">
                    The United States of America (USA) hosts the most number of international students in the 
                    world. Quality education, unique curriculum, multicultural environment, and abundant 
                    opportunities are just some of the reasons why many International students want to study in the US.
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-5 d-md-block d-none">
                <img src="<?= base_url('public/assets/images/destination/unitedstates.png') ?>" class="img-destination">
            </div>
            <div class="col-md-7">
                <div class="destination-article">
                    <div class="destination-heading">
                        <h3>Why United States?</h3>
                    </div>
                    <div class="destination-paragraph">
                        <p>
                            1. The United States is a country that has advanced technology and is always updated. <br>
                            2. High quality education and international standards. <br>
                            3. Granting permission to work part time for 20 hours per week during the school period
                            and permission to work full-time for 40 hours during school holidays.
                        </p>
                    </div>
                    <div class="destination-heading">
                        <h3>Living Cost in United States</h3>
                    </div>
                    <div class="destination-paragraph">
                        <p>
                            The living cost in US varies greatly depending on your lifestyle and the city in which you live.
                            The average living cost required by a student in US generally ranges from USD 1,300 to USD 2,700 per month.
                    ...
                    <div class="destination-paragraph">
                        <p>
                            To be able to enroll in an US university, you need to meet a number of conditions, such as: <br>
                            1. Student Visa <br>
